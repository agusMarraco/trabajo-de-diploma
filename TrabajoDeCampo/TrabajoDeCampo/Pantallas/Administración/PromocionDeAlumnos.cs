    ...
    public partial class PromocionDeAlumnos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.dataGridView1.DataSource = null;
                    this.dataGridView1.DataSource = this.administracion.listarAlumnosPorCursoYNivel(nivel, curso);
                }
                else
                {
                    MessageBox.Show("Seleccione datos de busqueda");
                }
